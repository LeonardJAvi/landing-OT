...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { banner: @destination.banner, name: @destination.name, subtitle: @destination.subtitle }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { banner: @destination.banner, name: @destination.name, subtitle: @destination.subtitle }
    assert_redirected_to destination_path(assigns(:destination))
  end
